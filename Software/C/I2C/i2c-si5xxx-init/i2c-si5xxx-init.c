...
//    int i2c_freq = FOUR_HUNDRED_KHZ;
    ...
    if(fp_si5xxx_data_file == NULL) {
        fprintf(stderr, "%sCannot open the Si5xxx data file `%s' for reading.", PREFIX_ERROR, si5xxx_data_file_name);
        return 1;
    }
...
int show_help(char* prog_name)
{
    printf("Initiale a Silicon Labs clock generator / jitter attenuator chip (e.g. Si5338,\n");
